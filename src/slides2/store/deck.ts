// Slides 2.0 deck store — isolado da aba Slides original.
// Idêntico em comportamento ao src/store/slidesFlow.ts, mas com chave de
// persistência e nome de hook próprios para evitar conflitos.
...
const useDeck = create<DeckState>()(
  persist(
    (set, get) => ({
      items: [],
      presets: [],
